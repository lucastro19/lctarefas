    ...
    <div className="min-h-screen bg-bg flex items-center justify-center">
      <div className="bg-card rounded-2xl shadow-md border border-border p-10 w-80 flex flex-col items-center gap-6">
        ...
        <button
          ...
          className="flex items-center gap-3 bg-white border border-border rounded-xl px-5 py-3 text-sm font-medium text-text-main hover:bg-bg transition-colors shadow-sm w-full justify-center"
        >
        ...
        <p className="text-xs text-text-secondary text-center">
          Seus dados ficam seguros com RLS no Supabase.
        </p>
      </div>
    </div>
  );
