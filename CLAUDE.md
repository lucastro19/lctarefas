...
```
src/
├── store/        # Zustand: auth, task, area, tag, settings, selection, ui, template, booking
├── pages/        # Uma por rota: Today, Inbox, Upcoming, Someday, Trash, Archive, Logbook,
│                 #   AreaPage, ProjectPage, TagPage, Calendar, Login, Landing, Admin, Book*
├── components/
│   ├── tasks/    # TaskCard, TaskDetail, TimedTaskList, TaskList, NewTaskInput,
│   │             #   BulkActionBar, SortBar, TimeSlotPickerModal
